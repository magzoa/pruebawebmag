...
public class ServletSpringMVC extends AbstractAnnotationConfigDispatcherServletInitializer {
	...
	protected Class<?>[] getRootConfigClasses() {
		...
		return new Class[]{SecurityConfiguration.class,AppWebConfiguration.class,JPAConfiguration.class,AmazonConfiguration.class,JPAProductionConfiguration.class};
	}
